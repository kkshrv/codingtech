...
int main(){
    ...
    addAfter(head, id1, id1, price1); // Добавляем элемент после id1
    cout << "===================================\n";
    addFirst(head, id1, price1); // Добавляем элемент в начало списка
    addAfter(head, 0, 4, price3); // Добавляем элемент после id = 0
    printList(head); 
    cout << "===================================\n";
    addAfter(head, id1, id2, price2); // Добавляем элемент после id1
    printList(head); 
    cout << "===================================\n";
    addAfter(head, id1, id3, price3); // Добавляем элемент после id1
    printList(head); 
    cout << "===================================\n";
    addAfter(head, 0, 4, price3); // Добавляем элемент после id = 0
    printList(head);
    cout << "===================================\n";
    addBefore(head, id3, id4, price4); // Добавляем элемент перед id3
    printList(head);
    cout << "===================================\n";
    delFromList(head, id1); // Удаляем элемент с id1
    printList(head);
    cout << "===================================\n";
    delFromList(head, id2); // Удаляем элемент с id2
    printList(head);
    return 0;
}